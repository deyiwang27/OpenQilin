"""In-memory policy runtime client — test use only.

Production code MUST use OPAPolicyRuntimeClient from
openqilin.policy_runtime_integration.client.
"""
...
class InMemoryPolicyRuntimeClient:
    """Deterministic in-memory policy client for unit and component tests."""
