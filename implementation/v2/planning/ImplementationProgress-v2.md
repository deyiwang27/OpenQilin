...
| M17-WP6 | Sponsorship and Startup-Credit Readiness | `done` | #166 | #<PR> | FUNDING.yml + sponsorship docs added (project summary, program shortlist, GitHub Sponsors setup guide) |
