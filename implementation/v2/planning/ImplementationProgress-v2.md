...
| M17 | `in_progress` | 3 / 6 | WP1-WP2-WP4 done |
...
| M17-WP4 | Contributor Entry Path | `done` | #160 | — | CONTRIBUTING.md + CODE_OF_CONDUCT.md added; CWO naming fix in README/ROADMAP; good first issues #161-#164 created; acceptance checks pass |
