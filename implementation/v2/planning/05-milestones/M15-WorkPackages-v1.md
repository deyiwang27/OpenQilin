# M15 Work Packages — Onboarding, Diagnostics, and Runtime Polish

Milestone: `M15`
Status: `planned`
Entry gate: M14 complete (all infrastructure wired, budget live, dashboard visible)
Design ref: `design/v2/architecture/M15-RuntimePolishModuleDesign-v2.md`, `design/v2/adr/ADR-0006`
...
## WP M15-01 — RuntimeSettings Singleton
...
**Bug ref:** M-1 | **Design ref:** `design/v2/architecture/M15-RuntimePolishModuleDesign-v2.md §3`
...
## WP M15-02 — Conversation History Persistence
...
**Bug ref:** M-2 | **Design ref:** `design/v2/architecture/M15-RuntimePolishModuleDesign-v2.md §3`
...
## WP M15-03 — Idempotency Namespace Separation
...
**Bug ref:** M-3 | **Design ref:** `design/v2/architecture/M15-RuntimePolishModuleDesign-v2.md §3`
...
## WP M15-04 — Doctor / Diagnostics CLI
...
**Design ref:** `design/v2/architecture/M15-RuntimePolishModuleDesign-v2.md §3`

**Entry criteria:** All M12–M14 infrastructure wired (PostgreSQL, Redis, OPA, OTel, Discord, Grafana).
...
## WP M15-05 — Loop Control Audit and Token Discipline
...
- `design/v2/architecture/M15-RuntimePolishModuleDesign-v2.md`
