# M16 Work Packages — Open-Source and Sponsorship Readiness

Milestone: `M16`
Status: `planned`
Entry gate: M15 complete (full runtime polished and stable)
...
## WP M16-01 — Public README and Repository Clarity
...
- [ ] Write root `README.md` with sections:
  ...
  - **Status** — MVP-v2 complete; what works, what is deferred
  ...
  - **Roadmap** — link to roadmap doc (WP M16-02)
  - **Contributing** — link to `CONTRIBUTING.md` (WP M16-04)
...
## WP M16-04 — Contributor Entry Path
...
## WP M16-05 — Website and Public Presence
...
## WP M16-06 — Sponsorship and Startup-Credit Readiness
